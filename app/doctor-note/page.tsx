...
const DoctorNoteForm: React.FC<DoctorNoteFormProps> = ({ onSubmit, initialNote }) => {
  ...
  const handleSymptomChange = (index: number, field: keyof Symptom, value: any) => {
    const newSymptoms = [...symptoms];
    (newSymptoms[index] as any)[field] = value;
  ...
  const handleDiagnosisChange = (index: number, field: keyof Diagnosis, value: any) => {
    ...
    (newDiagnosis[index] as any)[field] = value;
